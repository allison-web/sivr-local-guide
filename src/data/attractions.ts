...
export type OutdoorsSubcategory = 'waterfalls' | 'hiking-east' | 'hiking-central' | 'hiking-west';
...
export const outdoorsSubcategories: { id: OutdoorsSubcategory | 'all'; label: string; icon: string }[] = [
  ...
  { id: 'hiking-east', label: 'Hiking East', icon: 'TreePine' },
  { id: 'hiking-central', label: 'Hiking Central', icon: 'Trees' },
  { id: 'hiking-west', label: 'Hiking West', icon: 'Compass' },
];
...
export const attractions: Attraction[] = [
  ...
  },
  {
    ...
    category: 'outdoors',
    region: 'east',
    outdoorsSubcategory: ['waterfalls', 'hiking-east'],
  ...
  // HIKING EAST
  {
    ...
    category: 'outdoors',
    region: 'east',
    outdoorsSubcategory: ['hiking-east'],
  ...
  },
  {
    ...
    category: 'outdoors',
    region: 'east',
    outdoorsSubcategory: ['hiking-east', 'waterfalls'],
  ...
  // HIKING CENTRAL
  {
    ...
    category: 'outdoors',
    region: 'central',
    outdoorsSubcategory: ['hiking-central'],
  ...
  // HIKING WEST
  {
    ...
    category: 'outdoors',
    region: 'west',
    outdoorsSubcategory: ['hiking-west'],
